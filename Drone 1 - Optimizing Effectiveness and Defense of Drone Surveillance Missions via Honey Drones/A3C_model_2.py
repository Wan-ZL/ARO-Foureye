...
class Agent(mp.Process):
    def __init__(self, global_actor_critic, optim, input_dims, n_actions,
        ...
        self.scheduler = LambdaLR(optim, lr_lambda=self.lambda_function)
    ...
    def lambda_function(self, epoch):  # epoch increase one when scheduler.step() is called
        return self.config["LR_decay"] ** epoch
