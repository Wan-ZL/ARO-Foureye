...
class MultiAgent(mp.Process):
    ...
    def lambda_function_def(self, epoch):  # epoch increase one when scheduler.step() is called
        return self.lr_decay ** epoch

    def lambda_function_att(self, epoch):  # epoch increase one when scheduler.step() is called
        return self.lr_decay ** epoch
    ...
    def run(self) -> None:
        ...
        while self.g_ep.value < self.MAX_EP:
            ...
            # TODO: two scheduler will cause "cannot create new thread error".
            if self.is_custom_env:
